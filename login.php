...
//We need to test for a minimum version of PHP for security reasons
...
<body>
	...
	<?php // If we have a username, then the user got something wrong ?>
	<?php if ($username): ?>
