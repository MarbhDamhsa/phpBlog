...
function tryLogin(PDO $pdo, $username, $password)
{
    ...
    // Get the has from this row, and use 3rd party hashing library to check it
 ...
 * Logs the user in.
 *
 * For safety, we ask PHP to regenerate the cookie, so if a user logs
 * onto a site that a cracker has prepared for them, the cracker's
 * copy of the cookie ID will be useless
 *
